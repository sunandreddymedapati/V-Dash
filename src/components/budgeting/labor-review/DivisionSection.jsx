  ...
  return (
    <>
      ...
      <TableRow className="bg-gray-100 h-8">
        <TableCell className="font-bold border-r py-1">Division</TableCell>
      ...
      {/* Division Rows */}
      {Object.entries(tableData.divisions).map(([division, values]) => (
        <TableRow key={division} className="h-8">
          <TableCell className="font-medium border-r py-1">{division}</TableCell>
